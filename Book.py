...
def make_books(quantity):
    """
    В основной файл программы импортируется только эта функция. Она создает книги, "забирая" данные из Сети.
    Количество созданных книг - quantity.
    """
    all_book_data = []
