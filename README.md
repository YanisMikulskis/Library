...
Главное СНАЧАЛА создать окружение и запустить его, а ПОТОМ клонировать репо.
...
4) Клонируем мой репозиторий (git clone [ssh ключ])
5) Переходим в репозиторий и устанавливаем в него всё из файла requirements.txt (pip install -r requirements.txt)
